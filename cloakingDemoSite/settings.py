"""
Django settings for cloakingDemoSite project.
...
ROOT_URLCONF = 'cloakingDemoSite.urls'
...
WSGI_APPLICATION = 'cloakingDemoSite.wsgi.application'
...
GEO_BLOCKED_COUNTRY_CODES = ['BE', 'NL']
